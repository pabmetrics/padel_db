...
| `winner` | **Parcial, empeora con la antigüedad** | Confirmado el 18/09/2026 al ampliar el backfill a ~240 días: en los torneos más antiguos de la ventana (ej. Riyadh Season P1 2026, febrero; Gijón P2 2026), el **100% de los partidos** trae `winner: "hidden_free_plan"` en vez de `"team_1"`/`"team_2"` — no unos pocos partidos sueltos como con el marcador (2,5%), sino el torneo entero. Parece que el plan gratuito oculta cada vez más campos cuanto más viejo es el partido. Implicación real: `fact_resultado_torneo` y `ganancias_temporada` no pueden calcular nada para estos torneos por mucho que se amplíe la ventana de backfill — es un límite duro del plan gratuito, no de nuestro código (confirmado investigando por qué a Agustín Tapia le faltaban 34.250 € reales de esos dos torneos concretos) |
